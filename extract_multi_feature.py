...
traintestlist = {
    'ucf': 'imp_datasets/video_datasets/splits/ucfTrainTestlist',
    'hmdb': 'imp_datasets/video_datasets/splits/hmdb51TrainTestlist',
    'kinetics': 'imp_datasets/video_datasets/splits/kineticsTrainTestlist',
}
...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--model", default="ThreeTRXShiftLoopTime")
        parser.add_argument("--base_model", default="CNN_STRM")
        ...
        parser.add_argument(
            "--getitem_name", type=str, default='get_multi_fea'
        )

        args = parser.parse_args()
        if args.method == "resnet50":
            args.trans_linear_in_dim = 2048
        args.traintestlist = traintestlist[args.dataset]
    ...
    def extract(self):
        ...
        with torch.no_grad():
            for video_path, video in self.video_loader:
                ...
                save_path = os.path.join("imp_datasets/video_datasets/data", f"{self.args.dataset}_multi_feature", f"{self.args.model}_feature", video_path[0])
